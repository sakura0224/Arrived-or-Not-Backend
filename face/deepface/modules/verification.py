...
def verify(
    ...
    distances = []
    regions = []
    for img1_representation in img1_representations :
            # img2_representation = img2_embedding_obj[0]["embedding"]
        if distance_metric == "cosine":
            distance = find_cosine_distance(img2_representation, img1_representation)
        elif distance_metric == "euclidean":
            distance = find_euclidean_distance(img2_representation, img1_representation)
    ...
    resp_obj = {
        ...
        "facial_areas": {"img2": facial_areas},
...
def find_threshold(model_name: str, distance_metric: str) -> float:
    ...
    thresholds = {
        ...
        "ArcFace": {"cosine": 0.70, "euclidean": 4.15, "euclidean_l2": 1.13},
