...
def image_get(q, window_name, output_rtsp_url, snapshot_path):
    process = (
        ...
        # 2560x1440 / 640x480
        .input('pipe:', format='rawvideo', pix_fmt='bgr24', s=f'2560x1440', r=10)
    ...
    with torch.no_grad():
        while True:
            ...
            for face in faces:
                ...
                if abs(p_pred_deg) <= 15 and abs(y_pred_deg) <= 30 and abs(r_pred_deg) <= 20:
...
def run_single_camera():
    user_name, user_pwd, camera_ip = "admin", "Nb123456", "192.168.43.168"
    output_rtsp_url = 'rtsp://admin:Nb123456@192.168.43.49:8554/stream1'
